...
/***/ (function(module, exports, __webpack_require__) {
	...
	var specificity = __webpack_require__(10);
	
	window.getParseFilterCSS = function (cssElement) {
	  // section 1 variables
	  var sheets = document.styleSheets,
	      arrayOfMatchingRules = [];
	  // section 2 variables
	  var mappedMatchingRules, selectors, matchingSelectors;
	  // section 3 variables
	  var nestedArrayOfProperties,
	      arrayOfProperties = [],
	      listOfProperties = {},
	      duplicativeListOfSelectors,
	      listOfSelectors = [],
	      arr;
	...
	window.writeToBody = function (jqueryElement) {
	  ...
	  var selectors = computedProperties[0],
	      unorderedProperties = computedProperties[1],
	      orderedProperties = {},
	      cssPropertiesArray = [];
...
/***/ (function(module, exports, __webpack_require__) {
	...
	window.buildNestedNavigation = function () {
	  ...
	  $.makeArray($('.f-menu > ul li')).some(function (li, i) {
	    ...
	    if ($(li).find('a').attr('href') !== "components.html") {
	      return false;
	    }
	    ...
	    $(li).find('li').each(function (j, header) {
	      ...
	      $(idName).find('.f-item-group').each(function (k, component) {
	        ...
	        nested.append($('<li/>').append($('<a href="#' + $(component).attr('id') + '"/>').text($(component).find('h3.f-item-heading').text())));
	      });
	  ...
	  var lastId,
	      nav = $('.scrollSpy'),
	      topOffset = 30,
	      //number of pixels before the top that the selection should change
	  // All list items
